...
},{"core-js/fn/regexp/escape":2,"core-js/shim":295,"regenerator-runtime/runtime":310}],2:[function(require,module,exports){
...
},{"./_overArg":297}],297:[function(require,module,exports){
/**
...
},{"./_getPrototype":296,"./isObjectLike":298}],300:[function(require,module,exports){
//! moment.js
//! version : 2.15.1
...
},{"./createStore":307,"./utils/warning":309,"_process":301,"lodash/isPlainObject":299}],306:[function(require,module,exports){
"use strict";
...
},{"lodash/isPlainObject":299,"symbol-observable":311}],308:[function(require,module,exports){
(function (process){
'use strict';
...
},{"./applyMiddleware":303,"./bindActionCreators":304,"./combineReducers":305,"./compose":306,"./createStore":307,"./utils/warning":309,"_process":301}],309:[function(require,module,exports){
'use strict';
...
},{"_process":301}],311:[function(require,module,exports){
...
},{"./app/home":315,"babel-polyfill":1}],315:[function(require,module,exports){
'use strict';
...
var _rootStore = require('../common/rootStore');
...
var _comicWall = require('../comicWall/comicWall');

var _comicWall2 = _interopRequireDefault(_comicWall);

var _comicActions = require('../comics/comicActions');

var _comicActions2 = _interopRequireDefault(_comicActions);

var _comic = require('../comics/comic');

var _comic2 = _interopRequireDefault(_comic);

var _utilities = require('../services/utilities');

var _character = require('../characters/character');
...
var HomePage = function () {
    function HomePage() {
        ...
        _rootStore2.default.subscribe(this.storeUpdated);
    ...
    _createClass(HomePage, [{
        ...
        value: function storeUpdated() {
            var selectedComic = _rootStore2.default.getState().selectedComic;
        ...
        value: function onClickSuggestion(characterId) {
            console.log('comic selected ' + characterId);
            (0, _rootStore.action)(_comicActions2.default.fetchCharacters(characterId));
        }
    }, {
        ...
        value: function onChange(e) {
            ...
            this.timer = setTimeout(function () {
                ...
                _this.clearSuggestionsList();
                _index2.default.charactersStartingWith(partial).then(function (response) {
                    var comics = response.data.results;
                    comics.sort(function (a, b) {
                        return b.stories.available - a.stories.available;
                    });

                    _this.suggestions = comics.map(function (comic) {
                        console.log('name ' + comic.name);
                        var li = document.createElement("li");
                        li.innerText = comic.name + ' [' + comic.stories.available + ']';
                        li.onclick = function () {
                            _this.onClickSuggestion(comic.id);
                        };
                    ...
                    console.log(_this.suggestions.length);
                });
            }, 300);
        }
    }, {
...
},{"../characters/character":316,"../comicWall/comicWall":318,"../comics/comic":320,"../comics/comicActions":321,"../common/rootStore":329,"../services/index":332,"../services/utilities":333}],316:[function(require,module,exports){
'use strict';
...
var _imageFactory = require('../common/imageFactory');
...
var Character = function () {
    function Character() {
        ...
        _rootStore2.default.subscribe(this.stateUpdated);
    }

    _createClass(Character, [{
        key: 'stateUpdated',
        value: function stateUpdated() {
            //Character was selected/looked up.
            var selectedCharacter = _rootStore2.default.getState().character;
            if (selectedCharacter.timestamp != null && selectedCharacter.timestamp != this.lastUpdate) {
                ...
                (0, _utilities.clearHomeScreen)();
                this.renderCharacterDetails();

                //this.renderCharactersInComic();
                (0, _rootStore.action)(_comicActions2.default.fetchComicsWithCharacters(this.character.id));
            }

            //comics with the above characters has come in.
            var comics = _rootStore2.default.getState().comicsWithCurrentCharacter;
        ...
        key: 'selectComic',
        value: function selectComic(id) {
            console.log('comic pressed ' + id);
            (0, _rootStore.action)(_comicActions2.default.fetchSelectedSuggestion(id));
        }
    }, {
        key: 'renderComics',
        value: function renderComics() {
            ...
            if (this.comicCount == 0) {
                ...
                var thumbs = this.comics.map(function (comic) {
                    var img = _imageFactory2.default.getImage((0, _utilities.thumbnail)(comic, 'standard_medium'));
                    var id = comic.id;
                    img.imgElement().onclick = function () {
                        return _this.selectComic(id);
...
},{"../comics/comicActions":321,"../common/imageFactory":327,"../common/rootStore":329,"../services/utilities":333}],317:[function(require,module,exports){
"use strict";
...
var REQUEST_CHARACTERS = exports.REQUEST_CHARACTERS = 'REQUEST_CHARACTERS';
var RECEIVE_CHARACTER = exports.RECEIVE_CHARACTER = 'RECEIVE_CHARACTER';
var RECEIVE_CHARACTERS = exports.RECEIVE_CHARACTERS = 'RECEIVE_CHARACTERS';
var RECEIVED_CHARACTERS_IN_COMIC = exports.RECEIVED_CHARACTERS_IN_COMIC = 'RECEIVED_CHARACTERS_IN_COMIC';

exports.comicsWithCurrentCharacter = function () {
    var state = arguments.length <= 0 || arguments[0] === undefined ? {} : arguments[0];
    var action = arguments[1];
...
exports.selectedCharacter = function () {
    var state = arguments.length <= 0 || arguments[0] === undefined ? {} : arguments[0];
    var action = arguments[1];
...
var _wallActions = require('../comicWall/wallActions');
 ...
 */
var ComicWall = function () {
    function ComicWall() {
        _classCallCheck(this, ComicWall);
        ...
        _rootStore2.default.dispatch((0, _wallActions.getWallOfComics)()).then(function () {
            return console.log("All done fetching comics!");
        });

        _rootStore2.default.subscribe(this.storeUpdated);
    }

    _createClass(ComicWall, [{
        key: 'storeUpdated',
        value: function storeUpdated() {
            var wall = _rootStore2.default.getState().comicWall;
        ...
        key: 'changeComicClassnames',
        value: function changeComicClassnames(className) {
            var _this = this;

            this.comics.map(function (comic, i) {
                _this.images[i].imgElement().className = className;
            });
        }
    }, {
        key: 'render',
        value: function render() {
            ...
            if (this.div == null) {
                ...
                this.images = [];
                this.comics.map(function (c) {
                    var image = _imageFactory2.default.getImage(ComicWall.thumbnail(c));
                    //store for future changes to src
                    _this2.images.push(image);
                    _this2.div.appendChild(image.imgElement());
                });
                ...
                (0, _utilities.sleep)(1000)
                //switch src urls
                .then(function () {
                    _this2.comics.map(function (comic, i) {
                        _this2.images[i].imgElement().src = ComicWall.thumbnail(comic);
                    });
                })
                //sleep 500ms so images can load
                .then(function () {
                    return (0, _utilities.sleep)(500);
                })
                //fade images back in
                .then(function () {
                    _this2.changeComicClassnames("fadeIn");
                })
                //wait for animation to complete
                .then(function () {
                    return (0, _utilities.sleep)(1000);
                })
                //remove fadeIn class name
                .then(function () {
                    _this2.changeComicClassnames("");
                });
            }
        }
    }], [{
        key: 'thumbnail',
        value: function thumbnail(data) {
...
exports.default = ComicWall;

},{"../comicWall/wallActions":319,"../common/imageFactory":327,"../common/rootStore":329,"../services/utilities":333}],319:[function(require,module,exports){
'use strict';
...
var _comicReducers = require('../comics/comicReducers');
...
function receivedWallOfComics(json) {
    return {
        type: _comicReducers.RECEIVED_WALL_OFF_COMICS,
        payload: json
    };
} /**
   * Created by gooba on 23/09/2016.
...
exports.getWallOfComics = function () {
    return function (dispatch) {
        dispatch(_comicActions2.default.requestComics());
        return _index2.default.comics(-1).then(function (json) {
            return dispatch(receivedWallOfComics(json));
        });
    };
};

},{"../comics/comicActions":321,"../comics/comicReducers":322,"../services/index":332}],320:[function(require,module,exports){
'use strict';
...
var _comicActions = require('./comicActions');

var _comicActions2 = _interopRequireDefault(_comicActions);

var _currentStateActions = require('../common/currentStateActions');

var _currentStateReducers = require('../common/currentStateReducers');
...
var Comic = function () {
    ...
    _createClass(Comic, [{
        key: 'adjustForWindowSize',
        value: function adjustForWindowSize(appState) {
        ...
        key: 'getCreators',
        value: function getCreators(comic) {
            var defaultValue = {
                writer: [],
                penciller: [],
                "penciller (cover)": []
            ...
            try {
                return comic.creators.items.reduce(function (e, creator) {
        ...
        key: 'renderShowSelected',
        value: function renderShowSelected() {
            // debugger;
        ...
        key: 'renderCharactersInComic',
        value: function renderCharactersInComic() {
            ...
            if (this.characters.count == 0) {
                ...
                var images = characters.map(function (character) {
                    return '\n                <img src="' + (0, _utilities.thumbnail)(character, 'standard_medium') + '" class="characterThumbnail"/>\n            ';
                });
        ...
        value: function stateUpdated() {
            ...
            if (selectedComic.timestamp != null && selectedComic.timestamp != this.lastUpdate) {
                ...
                //this.renderCharactersInComic();
                (0, _rootStore.action)(_comicActions2.default.fetchCharactersInComic(comic.id));
            }

            var charactersInComic = _rootStore2.default.getState().charactersInComic;
            ...
            var comics = _rootStore2.default.getState().comics;
        ...
        value: function onClick(event) {
            ...
            (0, _rootStore.action)((0, _comicActions.selectComic)(this.comicData));
            //this will change the state to only show the selected comic. All the others will disappear
            (0, _rootStore.action)((0, _currentStateActions.setCurrentState)(_currentStateReducers.STATE_SHOWING_COMIC_AND_CHARACTERS));
        }
    }, {
        key: 'createImage',
        value: function createImage() {
            this.image = _imageFactory2.default.getImage((0, _utilities.thumbnail)());
...
},{"../common/currentStateActions":323,"../common/currentStateReducers":324,"../common/imageFactory":327,"../common/rootStore":329,"../services/utilities":333,"./comicActions":321,"moment":300}],321:[function(require,module,exports){
'use strict';
...
var _characterReducers = require('../characters/characterReducers');

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

var ComicActions = function () {
    function ComicActions() {
        _classCallCheck(this, ComicActions);
    }

    _createClass(ComicActions, null, [{
        key: 'requestComics',
        value: function requestComics() {
            return {
                type: _comicReducers.REQUEST_COMICS
            };
        }
    }, {
        key: 'receiveComics',
        value: function receiveComics(json) {
            return {
                type: _comicReducers.RECEIVE_COMICS,
                payload: json
            };
        }
    }, {
        key: 'receiveCharacters',
        value: function receiveCharacters(json) {
            return {
                type: _comicReducers.RECEIVE_CHARACTERS,
                payload: json
            };
        }
    }, {
        key: 'receiveComicsWithCharacter',
        value: function receiveComicsWithCharacter(json) {
            return {
                type: _characterReducers.RECEIVED_CHARACTERS_IN_COMIC,
                payload: json
            };
        }
    }, {
        key: 'receiveSelectedSuggestion',
        value: function receiveSelectedSuggestion(json) {
            return {
                type: _comicReducers.RECEIVE_SELECTED_SUGGESTION,
                payload: json
            };
        }
    }, {
        key: 'fetchComics',
        value: function fetchComics(id) {
            return function (dispatch) {
                dispatch(ComicActions.requestComics());
                return _index2.default.comics(id).then(function (json) {
                    return dispatch(ComicActions.receiveComics(json));
                });
            };
        }
    }, {
        key: 'fetchCharacters',
        value: function fetchCharacters(id) {
            return function (dispatch) {
                dispatch(ComicActions.asyncInProgress(true));
                return _index2.default.characters(id).then(function (json) {
                    return dispatch(ComicActions.receiveCharacter(json));
                }).then(function () {
                    return dispatch(ComicActions.asyncInProgress(false));
                });
            };
        }
    }, {
        key: 'fetchCharactersInComic',
        value: function fetchCharactersInComic(id) {
            return function (dispatch) {
                dispatch(ComicActions.asyncInProgress(true));
                return _index2.default.charactersInComic(id).then(function (json) {
                    return dispatch(ComicActions.receiveCharactersInComic(json));
                }).then(function () {
                    return dispatch(ComicActions.asyncInProgress(false));
                });
            };
        ...
        key: 'fetchSelectedSuggestion',
        value: function fetchSelectedSuggestion(id) {
            return function (dispatch) {
                dispatch(ComicActions.requestComics());
                return _index2.default.comics(id).then(function (json) {
                    return dispatch(ComicActions.selectComic(json));
                });
            };
        }
    }, {
        key: 'selectComic',
        value: function selectComic(comic) {
            console.log("select comic action");
            return {
                type: _comicReducers.SELECT_COMIC,
                payload: comic
            };
        }
    }, {
        key: 'asyncInProgress',
        value: function asyncInProgress(isInProgress) {
            return {
                type: _comicReducers.ASYNC_IN_PROGRESS,
                payload: isInProgress
            };
        }
    }, {
        key: 'receiveCharactersInComic',
        value: function receiveCharactersInComic(json) {
            return {
                type: _characterReducers.RECEIVED_CHARACTERS_IN_COMIC,
                payload: json
            };
        ...
        key: 'fetchComicsWithCharacters',
        value: function fetchComicsWithCharacters(id) {
            return function (dispatch) {
                dispatch(ComicActions.asyncInProgress(true));
                return _index2.default.comicsWithCharacters(id).then(function (json) {
                    return dispatch(ComicActions.receiveComicsWithCharacter(json));
                }).then(function () {
                    return dispatch(ComicActions.asyncInProgress(false));
                });
            };
        ...
        key: 'receiveCharacter',
        value: function receiveCharacter(json) {
            return {
                type: _characterReducers.RECEIVE_CHARACTER,
                payload: json
            };
        }
    }]);
...
exports.default = ComicActions;

},{"../characters/characterReducers":317,"../comics/comicReducers":322,"../services/index":332}],322:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
    value: true
});
exports.RECEIVED_WALL_OFF_COMICS = exports.RECEIVE_CHARACTERS = exports.RECEIVE_COMICS = exports.REQUEST_COMICS = exports.FETCH_COMICS = exports.ASYNC_IN_PROGRESS = exports.SELECT_COMIC = exports.RECEIVE_SELECTED_SUGGESTION = exports.SET_COMICS = exports.SUGGESTION_SELECTED = undefined;
 ...
 * Created by gooba on 20/09/2016.
 */
var SUGGESTION_SELECTED = exports.SUGGESTION_SELECTED = "SUGGESTION_SELECTED";
var SET_COMICS = exports.SET_COMICS = "SET_COMICS";
var RECEIVE_SELECTED_SUGGESTION = exports.RECEIVE_SELECTED_SUGGESTION = "RECEIVE_SELECTED_SUGGESTION";
var SELECT_COMIC = exports.SELECT_COMIC = "SELECT_COMIC";
var ASYNC_IN_PROGRESS = exports.ASYNC_IN_PROGRESS = "ASYNC_IN_PROGRESS";
var FETCH_COMICS = exports.FETCH_COMICS = "FETCH_COMICS";
var REQUEST_COMICS = exports.REQUEST_COMICS = 'REQUEST_COMICS';
var RECEIVE_COMICS = exports.RECEIVE_COMICS = 'RECEIVE_COMICS';
var RECEIVE_CHARACTERS = exports.RECEIVE_CHARACTERS = 'RECEIVE_CHARACTERS';
var RECEIVED_WALL_OFF_COMICS = exports.RECEIVED_WALL_OFF_COMICS = 'RECEIVED_WALL_OFF_COMICS';


exports.asyncInProgress = function () {
...
exports.charactersInComic = function () {
    var state = arguments.length <= 0 || arguments[0] === undefined ? [] : arguments[0];
    var action = arguments[1];

    switch (action.type) {
        case _characterReducers.RECEIVED_CHARACTERS_IN_COMIC:
            return {
                timestamp: Date.now(),
                characters: action.payload
            };
...
exports.selectedComic = function () {
    var state = arguments.length <= 0 || arguments[0] === undefined ? {} : arguments[0];
    var action = arguments[1];
...
},{"../characters/characterReducers":317}],323:[function(require,module,exports){
'use strict';

var _currentStateReducers = require('./currentStateReducers');

exports.setCurrentState = function (newState) {
    return {
        type: _currentStateReducers.SET_CURRENTSTATE,
        payload: newState
    };
}; /**
    * Created by gooba on 21/09/2016.
...
},{"./currentStateReducers":324}],324:[function(require,module,exports){
"use strict";
 ...
 * Created by gooba on 21/09/2016.
 */
var SET_CURRENTSTATE = exports.SET_CURRENTSTATE = "SET_CURRENTSTATE";

var STATE_SHOWING_INITIAL_COMICS = exports.STATE_SHOWING_INITIAL_COMICS = 0;
var STATE_SHOWING_COMIC_AND_CHARACTERS = exports.STATE_SHOWING_COMIC_AND_CHARACTERS = 1;
var STATE_SHOWING_CHARACTERS_AND_COMICS = exports.STATE_SHOWING_CHARACTERS_AND_COMICS = 2;

exports.currentState = function () {
    var state = arguments.length <= 0 || arguments[0] === undefined ? STATE_SHOWING_INITIAL_COMICS : arguments[0];
    var action = arguments[1];
...
var Deadpool = function () {
    function Deadpool() {
        _classCallCheck(this, Deadpool);

        this.elements = [];
    }

    _createClass(Deadpool, [{
        key: "add",
...
var _deadpool = require('./deadpool');

var _deadpool2 = _interopRequireDefault(_deadpool);
...
var deadpool = new _deadpool2.default();
...
var ImageFactory = function () {
    ...
    _createClass(ImageFactory, null, [{
        ...
        value: function getImage(src) {
            return deadpool.get(src) || new _image2.default(src);
        }
    }, {
        key: 'killImage',
        value: function killImage(image) {
            deadpool.add(image);
        }
    }]);
...
},{"../common/image":326,"./deadpool":325}],328:[function(require,module,exports){
'use strict';
...
var _windowReducers = require('../common/windowReducers');

var comicApp = (0, _redux.combineReducers)({
    asyncInProgress: _comicReducers.asyncInProgress,
    charactersInComic: _comicReducers.charactersInComic,
    currentState: _currentStateReducers.currentState,
    comics: _comicReducers.comics,
    comicWall: _comicReducers.comicWall,
    selectedComic: _comicReducers.selectedComic,
    comicsWithCurrentCharacter: _characterReducers.comicsWithCurrentCharacter,
    character: _characterReducers.character,
    characters: _characterReducers.characters,
    selectedCharacter: _characterReducers.selectedCharacter,
    windowSize: _windowReducers.windowSize
}); /**
     * Created by gooba on 20/09/2016.
     */
exports.default = comicApp;

},{"../characters/characterReducers":317,"../comics/comicReducers":322,"../common/currentStateReducers":324,"../common/windowReducers":331,"redux":308}],329:[function(require,module,exports){
'use strict';
...
var _rootReducers = require('./rootReducers');
...
var _windowActions = require('./windowActions');
 ...
 * Created by gooba on 20/09/2016.
 */
var rootStore = (0, _redux.createStore)(_rootReducers2.default, (0, _redux.applyMiddleware)(_reduxThunk2.default));
...
(0, _windowActions.watchWindowSize)();

},{"./rootReducers":328,"./windowActions":330,"redux":308,"redux-thunk":302}],330:[function(require,module,exports){
'use strict';

var _rootStore = require('./rootStore');

var _windowReducers = require('./windowReducers');
...
exports.watchWindowSize = function () {
    addEvent(window, "resize", function (event) {
        ...
        (0, _rootStore.action)({
            type: _windowReducers.CHANGE_WINDOW_SIZE,
            payload: {
                width: size.width,
                height: size.height
            }
...
},{"./rootStore":329,"./windowReducers":331}],331:[function(require,module,exports){
"use strict";
...
var CHANGE_WINDOW_SIZE = exports.CHANGE_WINDOW_SIZE = "CHANGE_WINDOW_SIZE";
...
exports.windowSize = function () {
    var state = arguments.length <= 0 || arguments[0] === undefined ? defaultWindowSize : arguments[0];
    var action = arguments[1];
...
var API_KEY = '072396c06e21f60ebd2a809681c932fd';
var baseUrl = 'http://gateway.marvel.com:80/v1/public/';
var charactersUrl = baseUrl + 'comics?orderBy=-onsaleDate&limit=10&apikey=' + API_KEY;
...
var services = function () {
    ...
    _createClass(services, null, [{
        key: 'comicsStartingWith',
        value: function comicsStartingWith(partial) {

            var comicUrl = baseUrl + 'comics?titleStartsWith=' + partial + '&apikey=' + API_KEY;
        ...
        key: 'charactersStartingWith',
        value: function charactersStartingWith(partial) {
            var comicUrl = baseUrl + 'characters?nameStartsWith=' + partial + '&apikey=' + API_KEY;
            return fetch(comicUrl, {
                method: "GET",
                mode: "cors",
                cache: "default"
        ...
        key: 'comicsWithCharacters',
        value: function comicsWithCharacters(id) {
            var comicUrl = baseUrl + 'characters/' + id + '/comics?limit=50&apikey=' + API_KEY;
        ...
        key: 'charactersInComic',
        value: function charactersInComic(id) {
            var comicUrl = baseUrl + 'comics/' + id + '/characters?apikey=' + API_KEY;
        ...
        key: 'characters',
        value: function characters(id) {
            var charactersUrl = baseUrl + 'characters/' + id + '?apikey=' + API_KEY;
            return fetch(charactersUrl).then(function (response) {
                return response.json();
            }).catch(function (error) {
                return error;
            });
...
var standard_small = exports.standard_small = 'standard_small';
var standard_medium = exports.standard_medium = 'standard_medium';
var standard_large = exports.standard_large = 'standard_large';
var standard_xlarge = exports.standard_xlarge = 'standard_xlarge';
var standard_fantastic = exports.standard_fantastic = 'standard_fantastic';
var standard_amazing = exports.standard_amazing = 'standard_amazing';

exports.thumbnail = function (comic, size) {
