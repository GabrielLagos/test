...
},{"core-js/fn/regexp/escape":2,"core-js/shim":295,"regenerator-runtime/runtime":309}],2:[function(require,module,exports){
...
},{"./compose":305}],303:[function(require,module,exports){
'use strict';
...
},{"./createStore":306,"./utils/warning":308,"_process":300,"lodash/isPlainObject":299}],305:[function(require,module,exports){
"use strict";
...
},{"lodash/isPlainObject":299,"symbol-observable":310}],307:[function(require,module,exports){
(function (process){
'use strict';
...
},{"./applyMiddleware":302,"./bindActionCreators":303,"./combineReducers":304,"./compose":305,"./createStore":306,"./utils/warning":308,"_process":300}],308:[function(require,module,exports){
'use strict';
...
},{"_process":300}],310:[function(require,module,exports){
module.exports = require('./lib/index');

},{"./lib/index":311}],311:[function(require,module,exports){
(function (global){
'use strict';
...
},{"./ponyfill":312}],312:[function(require,module,exports){
'use strict';
...
},{"./app/home":314,"babel-polyfill":1}],314:[function(require,module,exports){
'use strict';
...
var HomePage = function () {
    function HomePage() {
        ...
        _rootStore2.default.subscribe(this.update);
    ...
    _createClass(HomePage, [{
        ...
        value: function update() {
            var response = _rootStore2.default.getState().comics;
        ...
        key: 'loadInitialComicWall',
        value: function loadInitialComicWall() {
            this.latestComics && this.latestComics.map(function (comic, index) {
                var image = new _comic2.default(index);
                image.update();
            });
            this.render();
        }
...
},{"../comics/comic":315,"../common/rootStore":324}],315:[function(require,module,exports){
'use strict';
...
var comicSizes = ['standard_small', 'standard_medium', 'standard_large', 'standard_xlarge', 'standard_fantastic', 'standard_amazing'];
...
var Comic = function () {
    ...
    _createClass(Comic, [{
        ...
        value: function update() {
            ...
            var appState = _rootStore2.default.getState();
            ...
            if (appState.currentState == _currentStateReducers.STATE_SHOWING_COMIC_AND_CHARACTERS) {
        ...
        value: function createImage() {
            this.image = _imageFactory2.default.getImage(this.thumbnail());
...
},{"../common/currentStateActions":318,"../common/currentStateReducers":319,"../common/imageFactory":322,"../common/rootStore":324,"./comicActions":316}],316:[function(require,module,exports){
'use strict';
...
exports.fetchComics = function (id) {
    return function (dispatch) {
        dispatch(requestComics());
        return _index2.default.comics().then(function (json) {
            return dispatch(receiveComics(json));
        });
    };
};

exports.selectComic = function (comic) {
...
},{"../comics/comicReducers":317,"../services/index":327}],317:[function(require,module,exports){
"use strict";
...
},{"./currentStateReducers":319}],319:[function(require,module,exports){
"use strict";
...
},{"../common/image":321,"./deadpool":320}],323:[function(require,module,exports){
'use strict';
...
},{"../comics/comicReducers":317,"../common/currentStateReducers":319,"../common/windowReducers":326,"redux":307}],324:[function(require,module,exports){
'use strict';
...
rootStore.dispatch((0, _comicActions.fetchComics)()).then(function () {
...
},{"../comics/comicActions":316,"./rootReducers":323,"./windowActions":325,"redux":307,"redux-thunk":301}],325:[function(require,module,exports){
'use strict';
...
},{"./rootStore":324,"./windowReducers":326}],326:[function(require,module,exports){
"use strict";
...
var comicUrl = baseUrl + 'comics?orderBy=-onsaleDate&limit=80&apikey=' + API_KEY;
